...
const UserCart = (props) => {
	...
	const getCartDetails = async () => {
		let temp = await Axios.post("https://ecohub-mern-server.onrender.com/users/get-cart", {
	...
	const purchase = async () => {
		...
		setFinalCart([]);
		await Axios.post("https://ecohub-mern-server.onrender.com/users/empty-cart", {
	...
	const removeItemFromCart = async (id) => {
		const response = await Axios.post(
			"https://ecohub-mern-server.onrender.com/users/remove-from-cart",
			{
				product_id: id,
				user_id: userDetails._id,
			}
