...
export function Reply() {
    ...
    useEffect(() => {
        ...
        const getDetails = async () => {
            const messageDetails = await fetch(`http://localhost:5000/messages/${data.id}`);
    ...
    return (
        <>
            <container style={{ "margin": "5%", "padding": "5%" }}>
                ...
                <Text className={classes.title} style={{ "margin": "1%", "padding": "1%" }}>You are replying to a message</Text>
                    <Textarea
                        placeholder=""
